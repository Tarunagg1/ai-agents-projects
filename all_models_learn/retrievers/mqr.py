...
embaddin_model = OpenAIEmbeddings()

vector_store = FAISS.from_documents(docs, embedding=embaddin_model)

similarity_retriver = vector_store.as_retriever(search_type="similarity", search_kwargs={"k": 3})
